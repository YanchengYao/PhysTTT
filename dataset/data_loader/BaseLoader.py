...
class BaseLoader(Dataset):
    ...
    def chunk(self, frames, bvps, chunk_length):
        ...
        # yyc
        # frames_clips = [frames[i * chunk_length:(i + 1) * chunk_length] for i in range(1, clip_num-1)]
        # bvps_clips = [self.normalize_01(self.detrend(bvps[i * chunk_length:(i + 1) * chunk_length], 100)) for i in range(1, clip_num-1)]
